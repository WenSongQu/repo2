...
public class TrainactivityOrderController {
    ...
    public R<VCTrainactivityInfoVO> getTrainactivityOrderByOid(@PathVariable("oid") String oid) {
        VCTrainactivityInfoVO  vcTrainactivityDisplayVO = ivcOrdersService.selecTrainactivityOrderInfo(oid);
