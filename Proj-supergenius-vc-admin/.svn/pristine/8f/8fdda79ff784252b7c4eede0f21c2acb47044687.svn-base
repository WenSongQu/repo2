...
@Slf4j
@RequestMapping("/recommendOrder")
@Api(description="天才推荐人订单 ")
@RestController
public class RecommendOrderController {
    @Autowired
    IVCOrdersService ivcOrdersService;

    @ApiOperation("获取天才推荐人列表")
    ...
    public R<IPage<VCGuaranteeAndRecommendDisplayVO>> getVCRecommendDisplayDO(@RequestParam(name = "filtrate") String filtrateStr, @PathVariable int pageNum) {
        ...
        IPage<VCGuaranteeAndRecommendDisplayVO> vcGuaranteeAndRecommendDisplayDOIPage = ivcOrdersService.selectVCrecommendDisplayDO(new Page(pageNum, 10), vcFiltrateVO);
