...
public class DateUtil {
    ...
    public static final String FORMAT_DATE_LONG = "yyyyMMddHHmm";
    ...
    public static final String FORMAT_DATE_NianYueRi = "yyyy年MM月dd日";
    ...
    /**
     * @param date 判断是否是本周，取出日期，依据日期取出该日所在周所有日期，在依据这些日期是否和本日相等
     * @return
     */
